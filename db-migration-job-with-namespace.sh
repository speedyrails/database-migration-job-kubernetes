...
if [ -z "$1" ] || [ -z "$2" ] || [ -z "$3" ] || [ -z "$4" ] || [ -z "$5" ]; then
    ...
    echo "Usage:"
    echo "  ./db-migration-job.sh \"OCI_IMAGE:TAG\" \"K8s CONFIGMAP NAME LIST SEPARATED BY SPACES\" \"COMMAND_ENTRYPOINT\" \"COMMAND_ARGUMENT\" \"NAMESPACE\" \"MIGRATION_TIMEOUT_SECONDS\""
    echo "Example:"
